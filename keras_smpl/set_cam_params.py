...
def set_cam_params(smpl):
    ...
    cam_params[0, 0] = 32.0  # scaling in x direction
    cam_params[0, 1] = 32.0  # scaling in y direction
    cam_params[0, 2] = 32.0  # translation in x direction
    cam_params[0, 3] = 40.0  # translation in y direction
